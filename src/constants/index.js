export const navLinks = [
  ...
  export const TechStack = [
    ...
    },
    {
      ...
      "desc": "I have experience with React for front-end development and Node.js for server-side logic, and I’m continually learning how to improve my web apps, both in design and functionality, well cuz of ThreeJS xd"
    },
    {
  ...
  export const myProjects = [
    {
      title: 'APODS - NASA',
      desc: 'APODS is an astronomy of day day site, tailored to give you a glimpse of the outer planet!',
      subdesc:
        'Built a simple APODS app with ReactJS using NASA API merely for fun and to improve my skillset.',
      href: 'https://apods.vercel.app',
    ...
    {
      title: 'NetBoltZ - Network Optimizer',
      desc: 'NetBoltZ employs cutting-edge algorithms to optimize your internet connection, delivering the fastest possible speeds for seamless browsing, streaming, gaming, and more. ',
      subdesc:
      ...
      tags: [
        ...
        },
        {
          id: 3,
          name: 'C/C++',
          path: '/assets/techres/0.svg',
        },
      ],
    },
    {
      title: 'Based Tunnel - VPN & Tunnelling',
      desc: 'A VPN application that breaks the bounds of geo-locational blocks and gives you access to the whole internet',
      subdesc:
  ...
  export const calculateSizes = (isSmall, isMobile, isTablet) => {
    return {
      ...
      cubePosition: isSmall ? [2.5, -6.8, 0] : isMobile ? [5, -5, 0] : isTablet ? [5, -5, 0] : [9, -5.5, 0],
      reactLogoPosition: isSmall ? [3, 4, 0] : isMobile ? [4, 4, 0] : isTablet ? [5, 4, 0] : [12, 4, 0],
      ringPosition: isSmall ? [-5, 7, 0] : isMobile ? [-10, 10, 0] : isTablet ? [-12, 10, 0] : [-24, 10, 0],
      targetPosition: isSmall ? [-5, -10, -8.5] : isMobile ? [-9, -10, -10] : isTablet ? [-11, -7, -10] : [-13, -13, -10],
    };
  };
  ...
  export const workExperiences = [
    {
      id: 1,
      name: 'Web & cross-platform development',
      pos: 'Web Developer',
      duration: '2022 - Present',
      title: "I am currently in the process of refining my skills in full stack web development using frameworks like React. React serves as my go-to tool for daily use!",
    ...
    },
    {
      ...
      duration: '2020 - 2022',
      title: "Java gave me the power to unleash all my ideas into native mobile applications, which i quickly grew into it, and actively learning",
    ...
    },
    {
      ...
      pos: 'Self learning',
      duration: '2019 - 2020',
      title: "Lua shaped my whole life as a programmer, being the very first language i used. With limited third party libraries i was forced to write everything from scratch",
      icon: '/assets/techres/7.svg',
      animation: 'salute',
    },
  ];